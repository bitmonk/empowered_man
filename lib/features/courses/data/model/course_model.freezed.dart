...
class _$CourseModelImpl implements _CourseModel {
  const _$CourseModelImpl(
      ...
      @JsonKey(name: 'data') final List<Course>? data})
      : _data = data;
  ...
  @override
  String toString() {
    return 'CourseModel(success: $success, message: $message, data: $data)';
  }
...
abstract class _CourseModel implements CourseModel {
  const factory _CourseModel(
      ...
      @JsonKey(name: 'data') final List<Course>? data}) = _$CourseModelImpl;
