...
class _$ScoreQuestionDataImpl implements _ScoreQuestionData {
  ...
  @override
  String toString() {
    return 'ScoreQuestionData(questionScore: $questionScore, totalObtainedScore: $totalObtainedScore, totalScore: $totalScore)';
  }
  ...
  @override
  int get hashCode =>
      Object.hash(runtimeType, questionScore, totalObtainedScore, totalScore);
