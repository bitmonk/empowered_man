...
class _$UserListModelImpl implements _UserListModel {
  ...
  @override
  String toString() {
    return 'UserListModel(status: $status, message: $message, data: $data)';
  }
...
abstract class _UserListModel implements UserListModel {
  const factory _UserListModel(
      ...
      @JsonKey(name: 'data') final Data? data}) = _$UserListModelImpl;
...
class _$DataImpl implements _Data {
  const _$DataImpl({@JsonKey(name: 'users') final List<User>? users})
      : _users = users;
...
abstract class _Data implements Data {
  const factory _Data({@JsonKey(name: 'users') final List<User>? users}) =
      _$DataImpl;
