...
mixin _$Comment {
  ...
  @JsonKey(name: "replys")
  List<dynamic>? get replys => throw _privateConstructorUsedError;
...
abstract class $CommentCopyWith<$Res> {
  ...
  $Res call(
      ...
      @JsonKey(name: "replys") List<dynamic>? replys,
...
class _$CommentImpl implements _Comment {
  const _$CommentImpl(
      ...
      @JsonKey(name: "replys") final List<dynamic>? replys,
  ...
  final List<dynamic>? _replys;
  @override
  @JsonKey(name: "replys")
  List<dynamic>? get replys {
    final value = _replys;
    if (value == null) return null;
