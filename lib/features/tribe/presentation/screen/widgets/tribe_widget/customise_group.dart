...
class _CustomiseGroupState extends State<CustomiseGroup> {
  ...
  void initState() {
    super.initState();
    tribeController.groupNameController.text = widget.groupName ?? '';
                ...
                children: [
                  Padding(
                    ...
                    child: Row(
                      children: [
                        ClipOval(
                          child: Assets.images.chatUserPic.image(
                            height: 32,
                            width: 32,
                            fit: BoxFit.cover,
                          ),
                    ...
                    child: DottedBorder(
                      ...
                      child: Container(
                        ...
                        decoration: BoxDecoration(
                          border: Border.all(
                              color: Colors.white30, style: BorderStyle.none,),
                            ...
                            : Column(
                                children: [
                                  ClipRRect(
                                    ...
                                    child: Image.file(
                                      File(
                                          tribeController.groupImagePath.value,),
                                      height: 120,
                                      width: double.infinity,
                                      fit: BoxFit.cover,
                                    ),
